...
func TestTrim_S(t *testing.T) {
	...
	tr := Trim{Target: []core.Sequenceable{s}, Start: core.On(1), End: core.On(1)}
	...
	tr = Trim{Target: []core.Sequenceable{s}, Start: core.On(4), End: core.On(0)}
...
func TestTrim_Storex(t *testing.T) {
	...
	// tr = Trim{Target: []core.Sequenceable{failingNoteConvertable{}}, Start: core.On(1), End: core.On(1)}
...
func TestTrim_Replaced(t *testing.T) {
	...
	tr := Trim{Target: []core.Sequenceable{s1}, Start: core.On(0), End: core.On(0)}
	if core.IsIdenticalTo(tr, s1) {
		t.Error("should not be identical")
	}
	if !core.IsIdenticalTo(tr.Replaced(s1, s2).(Trim).Target[0], s2) {
		t.Error("not replaced")
	}
	if !core.IsIdenticalTo(tr.Replaced(tr, s2), s2) {
		t.Error("should be replaced by s2")
	}
	tr = Trim{Target: []core.Sequenceable{tr}, Start: core.On(0), End: core.On(0)}
	if !core.IsIdenticalTo(tr.Replaced(tr.Target[0], s2).(Trim).Target[0], s2) {
		t.Error("not replaced")
	}
	tr = Trim{Target: []core.Sequenceable{failingNoteConvertable{}}, Start: core.On(0), End: core.On(0)}
