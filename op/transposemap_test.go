...
func TestTransposeMap_S(t *testing.T) {
	...
	tr := NewTransposeMap([]core.Sequenceable{s}, core.On("1:1,3:2"))
...
func TestTransposeMap_Notes(t *testing.T) {
	s := core.MustParseSequence("C D E")
	tr := NewTransposeMap([]core.Sequenceable{s}, core.On("1:1,4:2"))
	if got, want := len(tr.Notes()), 1; got != want {
		t.Errorf("got [%v] want [%v]", got, want)
	}
	tr = NewTransposeMap([]core.Sequenceable{s}, core.On("1:0"))
...
func TestTransposeMap_Storex(t *testing.T) {
	...
	tr := NewTransposeMap([]core.Sequenceable{s}, core.On("1:1"))
...
func TestTransposeMap_Replaced(t *testing.T) {
	...
	tr := NewTransposeMap([]core.Sequenceable{s1}, core.On("1:1"))
	if core.IsIdenticalTo(tr, s1) {
		t.Error("should not be identical")
	}
	if !core.IsIdenticalTo(tr.Replaced(s1, s2).(TransposeMap).Target[0], s2) {
		t.Error("not replaced")
	}
	if !core.IsIdenticalTo(tr.Replaced(tr, s2), s2) {
		t.Error("should be replaced by s2")
	}
	tr = NewTransposeMap([]core.Sequenceable{tr}, core.On("1:1"))
	if !core.IsIdenticalTo(tr.Replaced(tr.Target[0], s2).(TransposeMap).Target[0], s2) {
		t.Error("not replaced")
	}
	tr = NewTransposeMap([]core.Sequenceable{failingNoteConvertable{}}, core.On("1:1"))
