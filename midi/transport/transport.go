...
const (
	noteOn        int16 = 0x90 // 10010000 , 144
	noteOff       int16 = 0x80 // 10000000 , 128
	controlChange int16 = 0xB0 // 10110000 , 176
	noteAllOff    int16 = 0x78 // 01111000 , 120  (not 123 because sustain)
	sustainPedal  int16 = 0x40
)
